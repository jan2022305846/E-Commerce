...
$sql = "SELECT * FROM products WHERE product_name = 'Vintage Brown Cow Leather Jacket'";
...
<body>
    ...
    <div class="product-container">
        <div class="left-section">
          <img class="product-image" src="<?php echo $product_image; ?>" alt="Brown Jacket">
        </div>
