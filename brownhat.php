...
$sql = "SELECT * FROM products WHERE product_name = 'Distressed Brown Cow Leather Hat'";
...
<body>
    ...
    <div class="product-container">
        <div class="left-section">
          <img class="product-image" src="<?php echo $product_image; ?>" alt="Brown Hat">
        </div>
