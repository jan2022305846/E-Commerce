...
$sql = "SELECT * FROM products WHERE product_name = 'Slim Fit Cow Leather Biker Jacket'";
...
<body>
    ...
    <div class="product-container">
        <div class="left-section">
          <img class="product-image" src="<?php echo $product_image; ?>" alt="Bicker Jacket">
        </div>
