...
$sql = "SELECT * FROM products WHERE product_name = 'Sleek Black Cow Leather Fedora'";
...
<body>
    ...
    <div class="product-container">
        <div class="left-section">
          <img class="product-image" src="<?php echo $product_image; ?>" alt="Black Fedora">
        </div>
