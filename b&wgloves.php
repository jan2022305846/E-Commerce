...
$sql = "SELECT * FROM products WHERE product_name = 'Elegant Black and White Cow Leather Gloves'";
...
<body>
    ...
    <div class="product-container">
        <div class="left-section">
          <img class="product-image" src="<?php echo $product_image; ?>" alt="B&W Gloves">
        </div>
