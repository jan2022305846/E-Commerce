...
$sql = "SELECT * FROM products WHERE product_name = 'Classic Black Cow Leather Shoes'";
...
<body>
    ...
    <div class="product-container">
        <div class="left-section">
          <img class="product-image" src="<?php echo $product_image; ?>" alt="Black Shoes">
        </div>
