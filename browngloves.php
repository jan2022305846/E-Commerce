...
$sql = "SELECT * FROM products WHERE product_name = 'Stylish Brown Cow Leather Gloves'";
...
<body>
    ...
    <div class="product-container">
        <div class="left-section">
          <img class="product-image" src="<?php echo $product_image; ?>" alt="Brown Gloves">
        </div>
