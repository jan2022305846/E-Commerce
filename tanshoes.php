...
$sql = "SELECT * FROM products WHERE product_name = 'Casual Tan Cow Leather Shoes'";
...
<body>
    ...
    <div class="product-container"> 
        <div class="left-section">
          <img class="product-image" src="<?php echo $product_image; ?>" alt="Tan Shoes">
        </div>
